...
const endpoints = { BASE_URL, LOGIN_URL, REGISTER_URL, GET_USER_URL, VERIFY_EMAIL_URL, RESEND_VERIFY_EMAIL_URL, BUY_CRYPTO_UrL, SELL_CRYPTO_URL, GET_SINGLE_RATE_URL }
