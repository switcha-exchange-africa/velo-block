    ...
    return(
      ...
      <VStack alignItems={"start"} gap={"1rem"}>
        ...
        <HStack 
         ...
         <Button isLoading={false} size={"md"} background={'#E5E5E5'} width={'8%'}>Verified</Button>
        </HStack>
        ...
        <HStack 
         ...
         <a>
         <MainAppButton isLoading={false} size={"md"} width={'90%'}>Verify</MainAppButton>
         </a>
         </Link>
        </HStack>
        ...
        <HStack 
         ...
         <Button isLoading={false} size={"md"} background={'#E5E5E5'} width={'8%'}>Verify</Button>
        </HStack>
